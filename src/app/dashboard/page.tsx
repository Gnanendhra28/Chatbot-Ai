...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: data?.stats?.indexedDocuments || 0,
      icon: Database,
      color: "#00ff94",
    },
    {
      title: "Qdrant Vector Count",
      value: data?.stats?.totalVectors || 0,
      icon: Zap,
      color: "#3b82f6",
    },
    {
      title: "Retrieval Success Rate",
      value: `${data?.stats?.retrievalSuccessRate ?? 100}%`,
      icon: BrainCircuit,
      color: "#10b981",
    },
    {
      title: "Avg Retrieval Latency",
      value: `${data?.stats?.avgRetrievalLatency || 0}ms`,
      icon: Clock3,
      color: "#06b6d4",
    },
    {
